"""CyberDefender IDS v1.0 — Complete Flask Backend with Real-Time IDS"""
...
auth=JWTAuth(secret=os.getenv("JWT_SECRET","cyberdefender-change-me-256bit-secret"))
store=AuthStore()
...
def gen_pdf():
    ...
    try:
        ...
        return send_file(buf,mimetype="application/pdf",as_attachment=True,download_name="cyberdefender_report.pdf")
...
def notify_email():
    ...
    try:
        send_email(to=to,subject=data.get("subject","CyberDefender IDS Report"),
