"""Cyberdefender IDS - Complete Training Pipeline targeting 90-95% accuracy."""
...
BASE  = '/CyberDefender/backend/data'
PLOTS = '/CyberDefender/frontend/assets/plots'
...
print("="*60)
print(" CyberDefender IDS — Training All 6 Models")
print("="*60)
...
def save_curves(kind='accuracy'):
    ...
    title = ('CyberDefender IDS — Training vs Validation Accuracy\nNSL-KDD: 95%+ | UNSW-NB15: 90%+'
             if kind=='accuracy' else
             'CyberDefender IDS — Training vs Validation Loss')
...
ax.set_title('CyberDefender IDS — All 6 Models Performance',fontsize=13,fontweight='bold')
